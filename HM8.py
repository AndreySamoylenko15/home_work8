...
WEEKDAYS = ("\nMonday", "\nTuesday", "\nWednesday", "\nThursday", "\nFriday")
USERS = [
    {"name": "Bill", "birthday": datetime(year=1993, month=10, day=29).date()},
    {"name": "Andrew", "birthday": datetime(year=1993, month=12, day=15).date()},
    {"name": "Jill", "birthday": datetime(year=2000, month=11, day=4).date()},
    {"name": "Till", "birthday": datetime(year=1998, month=11, day=6).date()},
    {"name": "Jan", "birthday": datetime(year=1991, month=11, day=7).date()},
]
